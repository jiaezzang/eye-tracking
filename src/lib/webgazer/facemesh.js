...
const TFFaceMesh = function () {
    ...
    this.model = faceLandmarksDetection.load(faceLandmarksDetection.SupportedPackages.mediapipeFacemesh, { maxFaces: 1 });
 ...
 */
TFFaceMesh.prototype.getEyePatches = async function (video, imageCanvas) {
